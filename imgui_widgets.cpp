...
bool ImGui::Checkbox(const char* label, bool* v)
{
	...
	else if (*v)
	{
		...
		// probs not good code
		// idk, it works lol
		window->DrawList->AddRectFilled({ check_bb.Min.x + 3.5f, check_bb.Min.y + 3.5f }, { check_bb.Min.x + width - 3.5f, check_bb.Min.y + height - 3.5f }, check_col, 2.0f);
